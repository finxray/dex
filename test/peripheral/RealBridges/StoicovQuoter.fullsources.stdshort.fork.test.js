...
describe("StoicovQuoter full-sources swap (V2,V3,TWAP,CL,stdShort)", function () {
  ...
  it("fetches full sources and prints mid/bid/ask", async function () {
    // 30bps, RISKY1 (ETH risky), gamma high
    ...
    // Full sources: V2|V3|TWAP|CL|stdShort
    const params = {
      asset0: USDC,
      asset1: WETH,
    ...
    console.log("Std short (bps*100):   " + sdShort.toString());
